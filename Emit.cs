...
namespace scsc
{
	public class Emit
	{
		...
		public void AddIncLocalVar(LocalVariableInfo localVariableInfo, MyParser.IncDecOps incOp)
		{
			switch (incOp) {
				case MyParser.IncDecOps.PostInc:
					il.Emit(OpCodes.Dup);
					il.Emit(OpCodes.Ldc_I4_1);
					il.Emit(OpCodes.Add);
					il.Emit(OpCodes.Stloc, (LocalBuilder)localVariableInfo);
					break;
				case MyParser.IncDecOps.PostDec:
					il.Emit(OpCodes.Dup);
					il.Emit(OpCodes.Ldc_I4_1);
					il.Emit(OpCodes.Sub);
					il.Emit(OpCodes.Stloc, (LocalBuilder)localVariableInfo);
					break;
				case MyParser.IncDecOps.PreInc:
					il.Emit(OpCodes.Ldc_I4_1);
					il.Emit(OpCodes.Add);
					il.Emit(OpCodes.Dup);
					il.Emit(OpCodes.Stloc, (LocalBuilder)localVariableInfo);
					break;
				case MyParser.IncDecOps.PreDec:
					il.Emit(OpCodes.Ldc_I4_1);
					il.Emit(OpCodes.Sub);
					il.Emit(OpCodes.Dup);
					il.Emit(OpCodes.Stloc, (LocalBuilder)localVariableInfo);
		...
		public void AddIncParameter(ParameterBuilder parameterInfo, MyParser.IncDecOps incOp)
		{
			switch (incOp) {
				case MyParser.IncDecOps.PostInc:
					il.Emit(OpCodes.Dup);
